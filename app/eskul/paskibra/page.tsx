...
const STATS = [
  { angka: '1972', label: 'Tahun Berdiri' },
  ...
  return (
    <>
      <style>{`
        ...
        .psk-prestasi-item:hover .psk-prestasi-tahun {
          color: #C8973A;
        }
        .psk-prestasi-line {
          width: 1px;
        ...
        .psk-cta-title span { color: #C8973A; }
        .psk-cta-sub {
          font-size: 14px;
      ...
      <div className="psk-root">
        ...
        <main>
          ...
          <section className="psk-section">
            <div className="psk-section-label">Mengapa Paskibra</div>
